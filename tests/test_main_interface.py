...
class TestCleaningProgressDialog:
    ...
    def test_initialization(self) -> None:
        ...
        dialog: CleaningProgressDialog = CleaningProgressDialog()
...
class TestMainWindow:
    ...
    def test_initialization(self, state_manager: StateManager, config_manager: ConfigManager) -> None:  # noqa: ARG002
        """Test MainWindow initialization."""
        controller: Mock = Mock()
        window: MainWindow = MainWindow(state_manager, controller)
    ...
    def test_setup_ui(self, state_manager: StateManager, config_manager: ConfigManager) -> None:  # noqa: ARG002
        """Test UI setup."""
        controller: Mock = Mock()
        window: MainWindow = MainWindow(state_manager, controller)
    ...
    def test_button_connections(self, state_manager: StateManager, config_manager: ConfigManager) -> None:  # noqa: ARG002
        """Test that buttons are properly connected."""
        controller: Mock = Mock()
        window: MainWindow = MainWindow(state_manager, controller)

        # Test button connections by calling the slots directly
        window._configure_load_order()  # noqa: SLF001
        controller.configure_load_order.assert_called_once()

        window._configure_mo2()  # noqa: SLF001
        controller.configure_mo2.assert_called_once()

        window._configure_xedit()  # noqa: SLF001
        controller.configure_xedit.assert_called_once()

        window._start_cleaning()  # noqa: SLF001
        controller.start_cleaning.assert_called_once()

        window._stop_cleaning()  # noqa: SLF001
        controller.stop_cleaning.assert_called_once()

    def test_mo2_mode_toggle(self, state_manager: StateManager, config_manager: ConfigManager) -> None:  # noqa: ARG002
        ...
        window._toggle_mo2_mode()  # noqa: SLF001
    ...
    def test_ui_update_from_state(self, state_manager: StateManager, config_manager: ConfigManager) -> None:  # noqa: ARG002
    ...
    def test_cleaning_started_handler(self, state_manager: StateManager, config_manager: ConfigManager) -> None:  # noqa: ARG002
        """Test handling of cleaning started event."""
        controller: Mock = Mock()
        window: MainWindow = MainWindow(state_manager, controller)

        # Simulate cleaning started
        window._on_cleaning_started()  # noqa: SLF001
    ...
    def test_cleaning_finished_handler(self, state_manager: StateManager, config_manager: ConfigManager) -> None:  # noqa: ARG002
        ...
        assert window.progress_dialog._cleaning_in_progress is False  # noqa: SLF001

    def test_progress_update_handler(self, state_manager: StateManager, config_manager: ConfigManager) -> None:  # noqa: ARG002
        ...
        window._on_progress_changed(3, 10)  # noqa: SLF001
    ...
    def test_plugin_processed_handler(self, state_manager: StateManager, config_manager: ConfigManager) -> None:  # noqa: ARG002
        ...
        window._on_plugin_processed("test.esp", "cleaned", "Successfully cleaned")  # noqa: SLF001

        # Check that current plugin was updated
        assert window.progress_dialog.current_plugin_label.text() == "Processing: test.esp"

    def test_menu_bar_creation(self, state_manager: StateManager, config_manager: ConfigManager) -> None:  # noqa: ARG002
    ...
    def test_about_dialog(self, state_manager: StateManager, config_manager: ConfigManager) -> None:  # noqa: ARG002
        """Test about dialog."""
        controller: Mock = Mock()
        window: MainWindow = MainWindow(state_manager, controller)
    ...
    def test_message_handlers(self, state_manager: StateManager, config_manager: ConfigManager) -> None:  # noqa: ARG002
    ...
    def test_status_update(self, state_manager: StateManager, config_manager: ConfigManager) -> None:  # noqa: ARG002
        """Test status bar updates."""
        controller: Mock = Mock()
        window: MainWindow = MainWindow(state_manager, controller)
        window._update_status("Test Status")  # noqa: SLF001
        if window.status_bar is not None:
            assert window.status_bar.currentMessage() == "Test Status"

    def test_logging(self, state_manager: StateManager, config_manager: ConfigManager) -> None:  # noqa: ARG002
        ...
        window._log("Test log message")  # noqa: SLF001
